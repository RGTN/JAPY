...
const float fxaaQualityEdgeThresholdMin = 0.03;
...
void main()
{
	FxaaFloat2 _pos = gl_TexCoord[0].st;
    ...
    gl_FragColor = FxaaPixelShader(_pos, fxaaConsolePosPos, sampler, sampler, sampler, fxaaQualityRcpFrame,
