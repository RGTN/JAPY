...
const float fxaaQualityEdgeThresholdMin = 0.00;
...
/*--------------------------------------------------------------------------*/
    ...
    #else
        #define FxaaTexOff(t, p, o, r) texture(t, p + (vec2(o) * r))
    #endif
...
void main()
{
	FxaaFloat2 _pos = texCoords;
	FxaaFloat4 fxaaConsolePosPos = vec4(0.0);
	
	FxaaFloat2 fxaaQualityRcpFrame = pixelSize;
	FxaaFloat4 fxaaConsoleRcpFrameOpt = vec4(0.0);
	FxaaFloat4 fxaaConsoleRcpFrameOpt2 = vec4(0.0);
	FxaaFloat4 fxaaConsole360RcpFrameOpt2 = vec4(0.0);
	...
	FxaaFloat4 fxaaConsole360ConstDir = vec4(0.0);
       
    fragColor = FxaaPixelShader(_pos, fxaaConsolePosPos, sampler, sampler, sampler, fxaaQualityRcpFrame,
    ...
    //fragColor = vec4(fxaaQualityRcpFrame.x * 10000);
}